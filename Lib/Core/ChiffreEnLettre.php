<?php
    ...
    /**
     * Conversion le chiffre en lettre
     *
     * @author Lansky
     *
     * @since 22/08/2022
    */
	...
	class ChiffreEnLettre
	{
         ...
         *
         * @param int or string $sasie Chiffre à convertir en lettre sans point ou virgule
         * @return string
        */        
        ...
        */
         ...
         * @return string
        */
        private function million($nombre,$unite,$dizaine,$centaine,$mille,$million)
        {
        ...
        #Gestion des milles
        private function mille($nombre, $unite, $dizaine, $centaine, $mille)
        {
            #si les mille comportent un seul chiffre
            ...
            if (strlen($mille) == 1) {
                ...
                if ($mille == 1) {
                    $this->enLettre.='';
                } elseif($mille <> 1) { #si ce chiffre<>1
        ...
        private function centaine($inmillier, $nombre, $unite, $dizaine, $centaine)
        {
            $unite      = substr($nombre, 2);
            $dizaine    = substr($nombre, 1, 1);
            $centaine   =substr($nombre, 0, 1);
            ...
            } elseif ($unite <> 0 and $dizaine <> 0) { #comme 695
                $nombre = substr($nombre,1);
                if ($centaine == 1) {
                    $this->enLettre .= 'cent ';
                    $this->dizaine(0, $nombre, $unite, $dizaine).' ';
        ...
        private function dizaine($inmillier, $nombre, $unite, $dizaine)
        {
            $unite      = substr($nombre, 1);
            $dizaine    = substr($nombre, 0, 1);
            #comme 70
